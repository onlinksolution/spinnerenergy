  ...
  return (
    <header className={navbar ? 'w-full px-4 py-2 fixed z-50 bg-primary transition-all duration-500' : 'w-full px-4 py-2 fixed z-50 bg-transparent transition-all duration-500'}>
      <nav className="w-full h-[3.5rem] flex justify-between items-center screen-max-width">
        ...
        <div id="menu-bar" className="max-sm:fixed max-sm:left-0 max-sm:top-[-100%] max-sm:w-full max-sm:h-2/3 max-sm:bg-primary max-sm:rounded-b-full flex max-sm:flex-col max-sm:text-center max-sm:justify-center max-sm:gap-10 duration-500 transition-all max-sm:py-12 max-sm:border-b-2 max-sm:border-b-white">
