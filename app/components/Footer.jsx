    ...
    <footer className='bg-primary'>
      <div className='pt-20 pb-10 main_container'>
        <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4 lg:gap-7 lg:pb-6'>
          ...
          <div>
            ...
            <ul className='flex gap-2 mt-2'>
              <Link href='https://web.facebook.com/profile.php?id=61550108486388' className='text-slate-400 hover:text-white duration-300 transition-all' target='_blank'><RiFacebookCircleLine size={32} /></Link>
              <Link href='https://instagram.com/spinnerenergy' className='text-slate-400 hover:text-white duration-300 transition-all' target='_blank'><RiInstagramLine size={32} /></Link>
              <Link href='https://vm.tiktok.com/ZS2KpuKr7/' className='text-slate-400 hover:text-white duration-300 transition-all' target='_blank'><RiTiktokLine size={32} /></Link>
            </ul>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-4 mt-4 md:justify-between md:flex-row'>
          ...
          <p className='text-slate-100 text-center text-sm'>Developed by <Link href='https://onlinksolutions.online/' className='hover:underline duration-300 transition-all' target='_blank'>Onlink Solutions.</Link></p>
        </div>
      </div>
    </footer>
  )
